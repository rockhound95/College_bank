...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td>
				<form  onSubmit="return dil(this)" action="CreateAccount" method="POST">
				
				  <table cellspacing="5" cellpadding="3">	
				   
					<tr><td>USER NAME:</td><td> <input type="text" name="username"/></td></tr>
					<tr><td>PASSWORD:</td><td> <input type="password" name="password"/></td></tr>
					<tr><td>ACCOUNT TYPE</td><td><input list="selection" name="selection"></td>
					...
					<tr><td>AMOUNT:</td><td> <input type="date" name="date"/></td></tr>
